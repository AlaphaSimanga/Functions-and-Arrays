...
//add new completed task of false at the beginning of the array

tasksCompleted.unshift(false);
console.log(tasksCompleted);

//Add a new completed task of true at the end of the array
tasksCompleted.push(true);
console.log(tasksCompleted);

tasksCompleted.push(false, false);
console.log(tasksCompleted);
...
function calculateAverage(arrayName){
    ...
    const average = total/arrayName.length;
    console.log(average); 
}
